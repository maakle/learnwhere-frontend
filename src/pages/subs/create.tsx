  ...
  return (
    <div className="flex bg-white">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1620307262982-6a53092802f3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" }}
      ></div>
...
export const getServerSideProps: GetServerSideProps = async ({ req, res }) => {
  try {
    ...
    await Axios.get('/auth', { headers: { cookie } })
